...
public class FloatingDictView extends SherlockFragment implements
                ...
                switch (msg.arg1) {
                    ...
                    case 200:
                        if (msg.obj.toString() != "ERROR") {
                            jukuuWebView.loadDataWithBaseURL(null, msg.obj.toString(),
    ...
    protected void showJukuu() {
        ...
        if (!AddonFuncUnt.checkNetworkStatus(getActivity())) {
            jukuuWebView.loadDataWithBaseURL(null, "<font color=red><b>Network unavailable</b></font>",
                    "text/html", "utf-8", null);
            return;
        }
    ...
    @Override
    public boolean onHeadWordNotFound(MdxView view, String headWord, int scrollX, int scrollY) {
        // TODO Auto-generated method stub
        return false;
    }
